...
function totalCost(event){
    ...
    price_field_content = price_field.innerText.replace('RM','')
    total_field.children[0].innerText = 'RM' +  quantity.value * price_field_content
    grandTotal()
...
function grandTotal(){
    ...
    for(let i = 0; i < all_total_fields.length; i++){
        all_prices = Number(all_total_fields[i].innerText.replace( 'RM',''))
        total+=all_prices
    }
    grand_total.children[0].innerText = 'RM'+total
